...
/**
 * gen-worktree-report Skill — CLI helper
 *
 ...
 *
 * When `/gen-worktree-report` is invoked from Claude Code, the slash
...
function showHelp(): void {
  console.log('');
  console.log(c.bold('gen-worktree-report') + ' — gather worktree context for a report');
  console.log('');
  console.log(c.bold('USAGE'));
  console.log('  gen-worktree-report [options]');
  console.log('  gen-worktree-report [options] <worktree-path>');
  console.log('');
  ...
  console.log('  gen-worktree-report                            # JSON for the current worktree');
  console.log('  gen-worktree-report --pretty                   # human summary');
  console.log('  gen-worktree-report --base develop             # diff against develop');
  console.log('  gen-worktree-report ../findependence-feature   # explicit worktree path');
  console.log('');
  console.log(c.dim('When invoked as the /gen-worktree-report slash command in Claude Code,'));
