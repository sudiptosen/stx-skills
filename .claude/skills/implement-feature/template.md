<!--
================================================================================
  IMPLEMENT-FEATURE PROMPT TEMPLATE (embedded in /implement-feature skill)

  The /implement-feature skill (see SKILL.md in this directory) interviews
...
FORM_FIELDS:
  - name: worktree_action
    ...
    help: reuse-current = run the wave inside the worktree you're already in. create-new = spawn a fresh worktree first. The /implement-feature skill auto-selects create-new when the user is on main.
