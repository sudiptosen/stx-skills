<!--
================================================================================
  FIX-ISSUE PROMPT TEMPLATE (embedded in /fix-issue skill)

  The /fix-issue skill (see SKILL.md in this directory) interviews the user
...
FORM_FIELDS:
  - name: worktree_action
    ...
    help: reuse-current = run the loop inside the worktree you're already in. create-new = spawn a fresh worktree first. The /fix-issue skill auto-selects create-new when the user is on main.
